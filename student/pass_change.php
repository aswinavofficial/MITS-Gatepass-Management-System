								 ...
								 <div class="row">
                                    <form action ="pass_change.php" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="" name="current_pass" class="form-control" id="field-1" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" name="new_pass" value="" class="form-control" id="new_pass" required>
                                                </div>
                                            </div>
											 ...
											 <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="conf_pass" value="" class="form-control" id="conf_pass" required>
                                                </div>
                                            </div>
