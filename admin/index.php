...
if (empty($_SESSION['regno'])) {
 ...
 $objUser = new User();
 $res=$objUser->user_data($_SESSION['regno'],"ADMIN");
            ...
            <div class='quick-area'>
                ...
                <div class='pull-right'>
                    <ul class="info-menu right-links list-inline list-unstyled">
                        <li class="profile">
                            <a href="#" data-toggle="dropdown" class="toggle">
                                <img src="../images/<?php echo $details['photo']; ?>" alt="" class="img-circle img-inline">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper"> 
                    ...
                    <div class="profile-info row">
                        ...
                        <div class="profile-image col-md-4 col-sm-4 col-xs-4">
                            <a href="">
                                <img src="../images/<?php echo $details['photo']; ?>" alt="" class="img-responsive img-circle">
                            </a>
                        </div>
